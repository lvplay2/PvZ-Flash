package com.popcap.flash.framework.widgets.ui
{
   ...
   public class ImageButtonWidget extends CWidget
   {
      ...
      public var mOverOffset:Point = new Point();
      
      public var mUpOffset:Point = new Point();
      
      public var mDownOffset:Point = new Point();
      ...
      public var mDisableOffset:Point = new Point();
      ...
      override public function contains(x:Number, y:Number) : Boolean
      {
         ...
         var alpha:uint = uint((color & 0xFF000000) >> 24);
         return alpha > 0;
      }
