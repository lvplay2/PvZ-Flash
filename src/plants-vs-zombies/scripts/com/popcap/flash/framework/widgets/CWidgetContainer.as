package com.popcap.flash.framework.widgets
{
   ...
   public class CWidgetContainer
   {
      ...
      public function markDirty(container:CWidgetContainer = null) : void
      {
         ...
         {
            found = false;
            aNumWidgets = int(this.widgets.length);
      ...
      public function sysColorChangesAll() : void
      {
         ...
         var aNumWidgets:int = int(this.widgets.length);
      ...
      {
         var w:CWidget = null;
         var index:Number = Number(this.widgets.indexOf(widget));
         if(index < 0)
         {
            return;
         }
      ...
      public function drawAll(flags:CModalFlags, g:Graphics2D) : void
      {
         ...
         if(this.clip && Boolean(flags.getFlags() & CWidgetManager.WIDGETFLAGS_CLIP))
         {
         }
         if(this.widgets.length == 0)
         {
      ...
      public function markDirtyFull(widget:CWidgetContainer = null) : void
      {
         ...
         i = index;
         for(var aNumWidgets:int = int(this.widgets.length); i < aNumWidgets; )
         {
            w = this.widgets[i];
