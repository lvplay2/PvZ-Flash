package com.popcap.flash.framework.widgets
{
   ...
   public class CWidget extends CWidgetContainer
   {
      ...
      protected var mBounds:Rectangle = new Rectangle();
      ...
      protected var mPolyShape:Vector.<Point> = new Vector.<Point>();
      ...
      public function setColors(theColors:Array) : void
      {
         ...
         var aNumColors:int = int(theColors.length);
      ...
      public function contains(x:Number, y:Number) : Boolean
      {
         ...
         var i:int = 0;
         var j:int = 0;
         var numVerts:int = int(this.mPolyShape.length);
         i = 0;
         j = numVerts - 1;
         while(i < numVerts)
         {
      ...
      public function widgetRemovedHelper() : void
      {
         ...
         var aNumInfos:int = int(modal.length);
      ...
      public function setPolyShape(vertices:Vector.<Point>) : void
      {
         ...
         var numVerts:int = int(vertices.length);
