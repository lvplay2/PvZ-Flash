package com.popcap.flash.framework.widgets
{
   ...
   public class CWidgetManager extends CWidgetContainer
   {
      ...
      public var deferredOverlayWidgets:Array = new Array();
      ...
      public var belowModalFlagsMod:CFlagsMod = new CFlagsMod();
      ...
      public var lostFocusFlagsMod:CFlagsMod = new CFlagsMod();
      ...
      public var defaultBelowModalFlagsMod:CFlagsMod = new CFlagsMod();
      ...
      public var preModalInfoList:Array = new Array();
      
      private var modalFlags:CModalFlags = new CModalFlags();
      ...
      public function doKeyUp(keyCode:uint) : void
      {
         ...
         if(keyCode == Keyboard.TAB && Boolean(this.keyDown[Keyboard.CONTROL]))
         {
            return;
         }
      ...
      public function flushDeferredOverlayWidgets(g:Graphics2D, maxPriority:Number) : void
      {
         ...
         do
         {
            ...
            aNumWidgets = int(this.deferredOverlayWidgets.length);
      ...
      public function drawScreen(g:Graphics2D) : void
      {
         ...
         var i:Number = 0;
         var w:CWidget = null;
         var aNumWidgets:int = int(widgets.length);
         for(i = 0; i < aNumWidgets; i++)
         {
            w = widgets[i];
            if(w.dirty)
         ...
         {
            g.pushState();
            aNumWidgets = int(widgets.length);
            for(i = 0; i < aNumWidgets; i++)
            {
               w = widgets[i];
