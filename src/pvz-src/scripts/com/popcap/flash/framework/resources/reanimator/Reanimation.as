package com.popcap.flash.framework.resources.reanimator
{
   ...
   public class Reanimation
   {
      ...
      private var mLoopType:ReanimLoopType = LOOP_TYPE_ALWAYS;
      ...
      private var mVisibleMap:Dictionary = new Dictionary();
      
      private var mCurrentTrack:String = null;
      
      private var mFrameTime:ReanimFrameTime = new ReanimFrameTime();
