package com.popcap.flash.games.pvz.logic.Zombies
{
   ...
   public class Zombie extends GameObject
   {
      ...
      private var scratchDrawPos:ZombieDrawPosition = new ZombieDrawPosition();
      ...
      private var mOverrideColor:Color = Color.ARGB(1,1,1,1);
      
      private var mAdditiveColor:Color = Color.ARGB(1,0,0,0);
      
      private var mHeadParticle:ParticleSystem;
      
      public var mZombieAttackRect:Rectangle;
      
      private var mZombieHitRect:Rectangle = new Rectangle();
      ...
      private var mScratchMatrix:Matrix = new Matrix();
