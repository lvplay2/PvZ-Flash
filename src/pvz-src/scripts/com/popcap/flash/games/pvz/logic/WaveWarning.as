package com.popcap.flash.games.pvz.logic
{
   ...
   public class WaveWarning
   {
      ...
      private var mScreenBounds:Rectangle = new Rectangle(0,0,540,405);
      ...
      private var mHugeWaveBounds:Rectangle = new Rectangle();
      ...
      private var mFinalWaveBounds:Rectangle = new Rectangle();
